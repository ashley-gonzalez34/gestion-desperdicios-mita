...
function output(input) {
  ...
  // But solves problem of entering something like 'hola1'

  let text = input.toLowerCase().replace(/[^\w\s]/gi, "").replace(/[\d]/gi, "").trim();
  text = text
    .replace(/ un /g, " ")   // 'cuéntame un chiste' -> 'cuéntame chiste'
    .replace(/me siento /g, "")
    .replace(/que es/g, "qué es")
    .replace(/por favor /g, "")
    .replace(/ por favor/g, "")
    .replace(/eres tu/g, "eres tú")
    .replace(/habla sobre /g, "");
