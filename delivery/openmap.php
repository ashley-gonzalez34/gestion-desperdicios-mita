...
<head>
    ...
    <title>Mostrar Ubicación Actual en el Mapa</title>
...
@import url('https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap');
  ...
  <header>
    ...
    <div id="loading-message">Cargando el mapa, por favor espere...</div>
    <div id="map-container"></div>
    <div id="city-name"></div>
    <div id="address"></div>
    <br>
    <!-- <h3>Detalles de dirección IP</h3>
    <p>Tu dirección IP : <span id="ip"></span></p>
      ...
      function initMap() {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
          ...
          L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: 'Datos del mapa &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contribuyentes',
            maxZoom: 18,
            tileSize: 512,
            zoomOffset: -1
          }).addTo(map);
        ...
        // }).addTo(map);
          ...
          // Retrieve the city name using OpenStreetMap API
            ...
            fetch(url)
              ...
              .then(function (data) {
                ...
                cityNameElement.innerHTML = "Estás en " + cityName;
          ...
          fetch(url)
            ...
            .then(data => {
              document.getElementById("address").innerHTML = `Estás en ${data.display_name}`;
              // Hide loading message once the map is loaded
  ...
  fetch("https://ipapi.co/json/")
    ...
    .catch(error => {
      console.log("Error al recuperar los datos de ubicación: " + error);
    });
}
